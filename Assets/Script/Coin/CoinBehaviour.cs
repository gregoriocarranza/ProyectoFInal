...
public class CoinBehaviour : MonoBehaviour
{
    ...
    public static Action<int> CoinGrabed;
    AudioSource Audio;

    [Header("Hoover Coin Behaviour")]
    ...
    public Vector3 rotAmplitude = Vector3.one;
    ...
    {
        Debug.Log("Coin Colected");
        CoinGrabed?.Invoke(CoinValue);
